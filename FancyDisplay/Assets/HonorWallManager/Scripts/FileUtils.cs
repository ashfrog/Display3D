...
public class FileUtils
{
    ...
    private static readonly string[] fileExtensions = { ".mp4", ".mov", ".m4v", ".avi", ".wmv", ".webm", ".mkv", ".ts", ".m3u8", ".jpg", ".jpeg", ".png" }; // 可根据需要添加其他视频格式的扩展名
    ...
    private static List<string> GetFilesEach(string folderPath, string[] fileExtensions)
    {
        ...
        {
            Debug.Log("读取文件列表异常:" + folderPath + ex.Message);
        }
        return files;
    }
