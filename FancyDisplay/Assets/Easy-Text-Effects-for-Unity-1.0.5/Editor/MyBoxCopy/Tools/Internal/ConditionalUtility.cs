...
using EasyTextEffects.Editor.MyBoxCopy.Extensions.EditorExtensions;
using UnityEditor;
...
namespace EasyTextEffects.Editor.MyBoxCopy.Tools.Internal
{
    public static class ConditionalUtility
    {
        public static bool IsConditionMatch(UnityEngine.Object owner, ConditionalData condition)
        {
            ...
            {
                if (EasyTextEffects.Editor.MyBoxCopy.Extensions.MyString.IsNullOrEmpty(fieldCondition.Field)) continue;
